...
console.log(12 === "12")  //  EQUALS - SAME BUT ALSO MUST BE SAME DATA TYPE
...
kevin.hobby = "billiards";
kevin["favorite color"] = "black";
...
console.log(kevin["favorite color"]); // must use square brackets and quotes of propery has a space
...
console.log(add_two("engine", "caboose")) 

//CONCATENATE STRINGS
console.log("engine" + "boxcar" + "caboose")

// TEMPLATE STRINGS USING BACKTICK
let favorite = "blue";
console.log(`I like the color ${favorite} best!!!`);
console.log(`Two plus two equals ${2 + 2}.`);

//LITERAL CHARACTERS LIKE NEWLINE AND TAB
//Prints out on three lines with the second and third line indented.
console.log("Kevin Long\n\t1750 6th st\n\tColumbia City, OR 97018");

/*

THINGS WE WILL LEARN SOON
THINGS WE WILL LEARN SOON
THINGS WE WILL LEARN SOON
